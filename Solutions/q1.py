...
df1.drop(['State-Name', '2+', '3+', 'Total', '1', '2'], axis=1, inplace=True)

df1.columns = ['state-code', 'percent-one', 'percent-two', 'percent-three']

df1.to_csv('output/percent-india.csv', index = False)
